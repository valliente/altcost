...
import { Search, Bell, ChevronDown, User, PlusCircle, Target, RefreshCw, Sparkles } from 'lucide-react';
      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-2xl bg-white border border-slate-200/80 text-xs font-semibold text-purple-600 hover:bg-slate-50 transition-all shadow-sm flex items-center space-x-1.5"
          >
